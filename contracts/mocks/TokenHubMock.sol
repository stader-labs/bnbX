...
contract TokenHubMock is ITokenHub {
    ...
    function transferOut(address, address, uint256, uint64 expireTime) external payable override returns (bool) {
    ...
    function relayFee() external pure override returns (uint256) {
        uint256 fee = 10_000_000_000_000_000; // 0.01 BNB on testnet, 0.002 BNB on mainnet
        return fee;
    }
}
